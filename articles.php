...
.multi-select-menu {
    ...
    display: none;
	color:#707683; font-weight:normal;font-size:12px;
}
...
.multi-select-container--positioned .multi-select-menu label {
 ...
 input[type = checkbox]{
	...
	#artTitle_0,#artTitle_1 {display:none; width:0px !important}
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row show-grid">
                                        <div class="col-xs-6 col-sm-6">
                                            ...
                                            <span ><select id="artTitle" name="artTitle" multiple>
                                                            <option value="Asc" >Alphabetically, A to Z</option><span class="geekmark"></span>
                                                            <option value="Desc">Alphabetically, Z to A</option>
                                                     </select></span> &nbsp;
                                            <span ><select id="artDate" name="artDate" multiple>
                                                            <option value="Desc">Date, newest to oldest</option>
                                                            <option value="Asc">Date, oldest to newes</option>
                                                        </select></span>&nbsp;
                                            <!--<span id="dataEssayshow"></span>--><span><select id="essayType" name="essayType" multiple></select></span>&nbsp;
                                            <span ><select id="dueDate" name="dueDate" multiple>
                                                            <option value="Desc">Due this week</option>
                                                            <option value="Desc">Due this month</option>
       ...
       <!-- <script src="js/raphael.min.js"></script>
		...
		$(document).ready(function () {
			$(window).on("load", function(){   // onload jQuery Ajax Call in PHP Script 
               ...
               $.ajax({
				type: 'POST',
				url: 'data/selectArticlelist.php',
				data: {mag:mag,artTitle:artTitle,artDate:artDate},
				cache: false,
			...
			$('#artTitle').on('change', function () {
					var artTitle = $(this).val(); 
					var mag = 1;
					var artDate = '';
					   $.ajax({
								type: 'POST',
			...
			$('#artDate').on('change', function () {
					var artDate = $(this).val(); 
					var mag = 1;
					 var artTitle ='';
					   $.ajax({
								type: 'POST',
		...
		document.getElementById("artTitle_0").disabled=true;
		document.getElementById("artTitle_1").disabled=true;
	  </script>
