        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                     <div class="row">
                        <div class="col-lg-12"><br><a href="<?php echo $needHelp; ?>" class="themelinkcolor"><i class="arrowFaq leftFaq"></i><span style="vertical-align:top"> Need Help</span></span></a><br><br>
                            <!--<div class="pageTitlenew">FAQs for Students</div><br>-->
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
