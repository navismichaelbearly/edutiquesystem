    ...
    <body oncontextmenu="return false;" >
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" ><div id="testback"></div>
                ...
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="chatBox" ><button class="btn btn-default btn-xl">Chat with support</button></div>
                </div>
                <!-- /.container-fluid -->
            </div>
            <!-- /#page-wrapper -->
		...
		$(document).ready(function () {
                  $(window).on('load', function() { // onload jQuery Ajax Calls in PHP Script
						...
						var messageRef ='<?php echo $_REQUEST['ref']; ?>';
						var techsuplog = '';
					   $.ajax({
								type: 'POST',
								url: 'data/selectMessagedetail.php',
								data: {messagelog:messagelog,techsuplog:techsuplog,messageRef:messageRef},
								cache: false,
