        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" ><div id="testback"></div>
                ...
                <div class="container-fluid"><div id="dataCommentsview1" style="background-color:#99FF00"></div>
                    ...
                    <div class="row">
                        <div id="rLoud" style="float:right"><div id="dataArticleinfo1"></div>
                                 <br>
                                 <?php 
                        ...
                        <div class="col-lg-9" >
                            ...
                            <article>
                                <div id="container-wrap"  style=" font-family:Arial !important">
                           ...
                           <?php }?>
                           <div align="right">
                           <?php if($activity_id11>0){?>
                           <a href="activity-detail.php?artID=<?php echo $_REQUEST['artID'];?>&actID=<?php echo $activity_id11;?>&magID=<?php echo $_REQUEST['magID'];?>" class="btn btn-default btn-xl" style="margin-bottom:20px;">Go to Activity</a>&nbsp;&nbsp;<?php }?>
                           <?php if($_SESSION["utypeid"]==$admtchconst){?><span><a href="task-assign.php?art_id=<?php echo $_REQUEST['artID'];?>" class="btn btn-default btn-xl" style="margin-bottom:20px; border:1px solid #999999; padding:5px 10px">Assign/Lock</a></span>&nbsp;&nbsp;<span><a href="task-log.php" class="btn btn-default btn-xl" style="margin-bottom:20px; border:1px solid #999999; padding:5px 10px">View Activity Log</a></span>&nbsp;&nbsp;<?php if($reflection_ques!=''){?><span><a href="reflection-logdetail.php?artID=<?php echo $_REQUEST['artID'];?>&actID=<?php echo $_REQUEST['actID'];?>&magID=<?php echo $_REQUEST['magID'];?>" class="btn btn-default btn-xl" style="margin-bottom:20px; border:1px solid #999999; padding:5px 10px">View Reflection Log</a></span><?php }?><?php }?>
                           <?php if($_SESSION["utypeid"]==$admstdconst){?>
                           <span id='dataReadarticle' class="btn btn-default btn-xl"  style="background-color:#f9f9f9; color:#333333; margin-bottom:20px; border:1px solid #999999; padding:5px 10px"></span><?php }?>
                           </div>
                        ...
                        <div class="col-lg-3" id="rightsidebar">
                           ...
                           <div><br><input type="button" class="btn btn-default" value="Add Content Aid" id="contentAid"></div>
                           <?php }?>
                            <div id="dataArticleinfo"></div>
                            <div id="contentAidinfo"></div>
                            <!--<br><br>
    ...
    border:1px solid #000000; color:#000000;" rows="5" ></textarea>
                  ...
                  <!--<div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                             ...
                             <!-- Modal popup form for content Aid -->
       <div class="modal fade" id="myModalcontentaid" role="dialog">
           <div class="modal-dialog">
              ...
              <div class="modal-content" id="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" id="Myformcontentaid" >
                            <fieldset>
                                
                                <div class="form-group"><label>Title/Caption</label><br>
                                    <input type="text" class="form-control"  name="ca_title" id="ca_title" required style="outline: none !important;
    border:1px solid #000000; color:#000000;"  >
                                    
                                </div>
                                <p class="normaltext">Upload .CSV file:</p>
                                <div class="form-group"><label>Upload a File</label><br>
                                                <div class="normaltext">
                                                     Acceptable files are within 40MB and in the following formats:
                                                        <ul><li>Audio Files (.mp3)</li>
                                                        <li>Video Files (.mp4, .mov)</li>
                                                        <li>Other Files (.jpg, .png, .pdf, .doc, .docx, .ppt, .pptx, .xls, .xlsx)</li></ul>
                                                </div>
                                ...
                                <div class="form-group"><label>Embed a Video from YouTube</label><br>
                                    <textarea class="form-control"  name="ca_youtube" id="ca_youtube" style="outline: none !important;
    border:1px solid #000000; color:#000000;" rows="5" ></textarea>
                                </div>
                                
                                <input type="submit" class="btn btn-lg btn-success btn-block" value="Upload" id="uploadAidcontent"   >
                            </fieldset>
                        </form>
                 </div>
                  <!--<div class="modal-footer">
		     ...
		     $(window).on('load', function() { 
				   var artDetail = 1;
					...
					var aidsLog = 1;
					 $.ajax({
								type: 'POST',
								url: 'data/viewContentaids.php',
								data: {aidsLog:aidsLog, art_id:art_id, mag_id:mag_id},
								cache: false,
								success: function(data){
								   $("#contentAidinfo").html(data);
								   $("#dataArticleinfo1").html(data);
					     ...
					     return false;
						   ...
						   $.ajax({
									...
									success: function(data){
									   ...
									   $('#anno_comments').val('');
									   $('#myModal').modal('hide');
									   window.location='article-detail.php?artID=<?php echo $_REQUEST['artID'];?>&actID=<?php echo $_REQUEST['actID'];?>&magID=<?php echo $_REQUEST['magID'];?>';
									   displayComment();
...
$(document).ready(function(){
			...
			$('#contentAid').on('click', function () {  // onclic function
			      $('#myModalcontentaid').modal({
										  backdrop: 'static',
										  keyboard: true, 
										 show: true
					        });
		   ...
		   $("#file").change(function() {
						...
						var match = ['image/jpeg', 'image/png', 'image/jpg', 'audio/mpeg', 'audio/mp3', 'audio/mpeg', 'video/mp4', 'video/mov', 'application/pdf', 'application/msword', 'application/vnd.ms-office', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/vnd.ms-powerpoint', 'application/vnd.openxmlformats-officedocument.presentationml.presentation', 'application/vnd.ms-excel', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'];
						if(!((fileType == match[0]) || (fileType == match[1]) || (fileType == match[2]) || (fileType == match[3]) || (fileType == match[4]) || (fileType == match[5]) || (fileType == match[6]) || (fileType == match[7]) || (fileType == match[8]) || (fileType == match[9]) || (fileType == match[10]) || (fileType == match[11]) || (fileType == match[12]) || (fileType == match[13]) || (fileType == match[14]) || (fileType == match[15]) )){
							alert('Sorry, only JPG, JPEG, PNG, pdf, doc, docx, ppt, pptx, xls, xlsx, mp3, mp4, & mov files are allowed to upload.');
							$("#file").val('');
							return false;
						}
					});
		   $('#Myformcontentaid ').on('submit', function (e) { 
					       e.preventDefault();
				 //$(document).on('submit', '#uploadcsv', function(){
                  ...
                  /* if((fsize > 100000000)){
                      alert("Image File Size should be less than 100MB");
					   ...
					   data.append("art_id", '<?php echo $_REQUEST['artID']; ?>');
					   data.append("act_id", '<?php echo $_REQUEST['actID']; ?>');
					   data.append("mag_id", '<?php echo $_REQUEST['magID']; ?>');
					   /* jQuery Ajax Call in PHP Script */
                       $.ajax({
                               url:"data/uploadContentaid.php",
							   method:"POST",
							   data: data,
							   cache: false,
							   processData:false,
