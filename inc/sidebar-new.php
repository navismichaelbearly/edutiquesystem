    ...
    <div class="sidebar-nav navbar-collapse" id="testsidemenu">
        <ul class="nav" id="side-menu">
            ...
            <?php if ($col1 == $admconst) {  /* checks if logged in user is Admin and displays menu for Admin */ ?>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="upload-content.php?artID=0">Add Articles</a>
                        </li>
                        <li>
                            <a href="upload-content-activity.php?actID=0">Add Activities</a>
                        </li>
            ...
            <?php } elseif ($col1 == $admstdconst) { /* checks if logged in user is Student and displays menu for Student */ ?>
                ...
                <?php
                $q = $_SESSION["id"];
                $sql = "SELECT school_id FROM edu_user_school_level_class WHERE `user_id` = '$q'";
                ...
                // sql for select * from edu_onoff_bulk where school_id = $school_id
                $sql = "SELECT * FROM edu_onoff_bulk WHERE school_id = '$school_id'";
                // prepare query for execution
