    ...
    <body oncontextmenu="return false;"  style="background-color:#f5f6f8" >
                    ...
                    <form name="addNQform" id="addNQform">
					 <div class="row">
                        ...
                        <div class="col-lg-12">&nbsp;
							...
							<!--<div ><table style="background-color:transparent"><tr><td class="pageTitlenew">FAQs for &nbsp;&nbsp;</td><td><input type="text" name="faqfor[]"  class="form-control" placeholder="Stakeholder" required="required" id="faqfor"></td></tr></table> </div><br>
                            <div id="dynamic_field">
                             ...
                             <button  class="btn btn-lg btn-success btn-block" id="saveNQ" >Save Changes</button>
                              <!--<button class="btn btn-lg btn-success btn-block " id="saveNQ" >Save Changes</button>-->
                              <br><br>
                             <div class="chatBox" > <a href="addFAQ.php" class="btn btn-lg btn-success btn-block "  >Add a new question</a></div>  
		...
		$(document).ready(function(){
		  $(window).on("load", function(){   // onload jQuery Ajax Call in PHP Script 
			    var faqType = '<?php echo $_REQUEST['faqType']; ?>';
               $.ajax({
				type: 'POST',
				url: 'data/editFaqlist.php',
	      ...
	      $('#addNQ').click(function(){
			...
			$("#addNQform").on("submit", function () {
				...
				$.ajax({
					url:"data/updateFaqlist.php",
					method:"POST",
					data: $('#addNQform').serialize(),
					success:function(data)
					{
						alert("FAQ Qustion and Answer Updated sucessfully");
						window.location='editFAQ.php?faqType=<?php echo $_REQUEST['faqType']; ?>';
						$('#addNQform')[0].reset();
					}
