	...
	{ 
	   ...
	   $uploadStatus = 1; 
	     ...
	     if($_FILES['my_file']['name'] !=''){
			  ...
			  $stmt1 = $mysqli->prepare("delete FROM edu_article_audio where article_id=?");
