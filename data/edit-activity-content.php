                      ...
                      <span>
                        <select name="activity_type_id" id="activity_type_id" class="form-control formfield selectheadback">
                          ...
                          if ($stmt = $mysqli->prepare("SELECT activity_type_id,activity_type FROM edu_activity_type where activity_type_status=?")) {
                            ...
                            while ($stmt->fetch()) {
                              echo " <option   value='" . $mag_type_id . "' " . (($mag_type_id == $activity_type_id) ? 'selected="selected"' : "") . ">" . $mag_type . "</option>";
                            }
                          }
                          ?>
                        </select>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="form-group">
                      <span>
                        ...
                        while ($stmt->fetch()) {
                          echo "<option style='font-family: Poppins !important;' value='" . $essay_type . "' " . (($essay_type == $article_id) ? 'selected="selected"' : "") . ">" . $essay_type . "</option>";
                          $sr++;
                        }
                        echo "</datalist>"; ?>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      if ($("#activity_type_id").val() == "8") {
          ...
          var arr0 = <?php $q = "[]";  echo ($activity_result ?? $q);?>;
