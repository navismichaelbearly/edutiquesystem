              ...
              <fieldset>
                      ...
                      <span>
                        <select name="activity_type_id" id="activity_type_id" class="form-control formfield selectheadback">
                          ...
                          if ($stmt = $mysqli->prepare("SELECT activity_type_id,activity_type FROM edu_activity_type where activity_type_status=?")) {
                            ...
                            while ($stmt->fetch()) {
                              echo " <option   value='" . $act_type_id1 . "' " . (($act_type_id1 == $activity_type_id) ? 'selected="selected"' : "") . ">" . $act_type . "</option>";
                            }
                          }
                          ?>
                        </select>
                ...
                <div class="row">
                  <div class="col-lg-4">
                    ...
                    <div class="form-group">
                          <span > 
                                  <input type="date" id="act_year" name="act_year" class="form-control formfield"  value="<?php if($act_year !='') { echo $newDate = date("Y-m-d", strtotime($act_year));	 } else {  }  ?>" />
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="form-group">
                      <span>
                        ...
                        while ($stmt->fetch()) {
                          echo "<option style='font-family: Poppins !important;' value='" . $essay_type . "' " . (($essay_type_id == $article_id) ? 'selected="selected"' : "") . ">" . $essay_type . "</option>";
                          $sr++;
                        }
                        echo "</datalist>"; ?>
                ...
                <span style="display: none;">
                  <input type="hidden" name="activity_html" id="activity_html" value="<?php echo htmlspecialchars($activity_html); ?>">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 activity" id='unscramble'>
                    ...
                    <div class="form-group">
                      ...
                      <div class="row container" id='scramble_block'>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#upload_content ').on('click', function(e) {
        ...
        $('#Myform ').on('submit', function(e) {
          ...
          data.append('dummyArtid', '<?php echo $activity_id; ?>');
      ...
      $('#savedraft').on('click', function(e) {
        ...
        $('#Myform ').on('submit', function(e) {
          ...
          $.ajax({
            type: 'POST',
            url: 'data/editTodarftactivity.php?actId=<?php echo $param_user_id; ?>',
            data: data,
            cache: false,
            processData: false,
            contentType: false,
    ...
    $(document).ready(function() {
      ...
      if ($("#activity_type_id").val() == "8") {
        ...
        var arr0 = <?php $q = "[]"; if (empty($activity_result)) { echo $q; } else { echo ($activity_result); } ?>;
          ...
          if ($(this).hasClass("scrambleinput")) {
            ...
            for (var i = 1; i <= span_value; i++) {
              ...
              if (val != "" && val1 != "") {
                ...
                $("#disp_scram").append(`Scrambled: ` + val + ` &nbsp &nbsp <input class="formfield inp" name="sc` + i + `" id="sc` + i + `" data-answer="` + val1 + `"> `);
                activity_html += `
                <div class="row"><div class="col-md-3 align-middle">Scrambled: ` + val + `  &nbsp &nbsp </div><div class="col-md-3"><input class="inp" name="sc` + i + `" id="sc` + i + `" data-answer="` + val1 + `"> <br></div></div>
                `;
              }
            }
