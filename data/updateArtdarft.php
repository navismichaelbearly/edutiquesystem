    ...
    if(!empty($title) ){ 
	   ...
	   $uploadStatus = 1; 
			...
			if($uploadStatus == 1){ 
                ...
                $stmt = $mysqli->prepare("UPDATE edu_article_dummy SET article_title=?,article_published_date=?,mag_id=?,article_status=?,essay_type_id=?,article_path=?,article_image=?,article_content=?, 	article_style=?,audio_path=?,art_year=?,theme=?,genre=?,topic_words=?,audio_support=? ,fiction=?,difficulty_level=?,description=?,word_count=? ,author=?,issue_no=?, last_modified=? where article_id=?");	
		  $stmt->bind_param("sssssssssssssssssssssss", $param_article_title,$param_article_published_date,$param_mag_id,$param_article_status,$param_essay_type_id,$param_article_path,$param_article_image,$param_article_content, 	$param_article_style,$param_audio_path,$param_art_year,$param_theme,$param_genre,$param_topic_words,$param_audio_support ,$param_fiction,$param_difficulty_level,$param_description,$param_word_count ,$param_author,$param_issue_no,$param_last_modified,$param_article_id);  
